...
mkdir -p logs configs/tuning_multiseed/generated

BASE_CONFIG="configs/tuning_multiseed/RACE_bs16_lr20e-6.json"

for seed in 42 2025 0 1; do
  out_dir="results/tuning_multiseed/bs16_lr20e-6/seed_${seed}"
  cfg="configs/tuning_multiseed/generated/RACE_bs16_lr20e-6_seed_${seed}.json"
  log_file="logs/tuned_bs16_lr20_seed_${seed}.log"
  ...
  echo "==== tuned bs16_lr20e-6 seed ${seed} ====" | tee -a "$log_file"
