...
def normalize_model_name(name):
    ...
    # Order matters: check for more specific names first.
    model_map = {
    ...
    # Direct match for keys that might be substrings of others
    if norm_name in model_map:
        return model_map[norm_name]

    # Fallback for cases like "GPT-4" which becomes "gpt-4"
